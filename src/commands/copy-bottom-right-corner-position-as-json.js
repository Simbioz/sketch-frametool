...
export default function (context) {
  ...
  const point = { x: normalizedFrame.x + normalizedFrame.width, y: normalizedFrame.y + normalizedFrame.height };

  copyStringToClipboard(`{"x": ${point.x}, "y": ${point.y}}`);
  showCopiedToClipboardMessage(context, "Bottom right corner position");
}
